...
🟢 Valore basso → LED verde acceso (L’aria è pulita, nessun pericolo rilevato)
🟠 Valore medio → LED arancione acceso (Presenza moderata di gas, situazione da monitorare)
🔴 Valore alto → LED rosso acceso + buzzer attivo (Livello pericoloso di gas, viene attivato l’allarme sonoro)
